...
//         <Link
//           href="/shop"
//           className="inline-flex items-center gap-3 text-gray-700 hover:text-purple-600 font-semibold text-lg transition-all duration-300 group"
//         >
...
//                 alt={product.title}
//                 className="w-full h-full object-cover max-h-96 lg:max-h-full lg:h-full hover:scale-105 transition-transform duration-1000"
//               />
//               <div className="absolute top-6 left-6">
//                 <span className="bg-red-600 text-white px-5 py-2 rounded-full font-bold text-sm shadow-lg">
//                   BEST SELLER
//                 </span>
//               </div>
//             </div>
...
//               {/* Meta Info */}
//               <div className="grid grid-cols-2 gap-6 mb-10 text-gray-700">
...
//               {/* Action Button */}
//               <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold text-xl py-6 rounded-2xl hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-purple-500/50 flex items-center justify-center gap-4">
...
// Fully responsive version of Product Details page
// src/app/shop/[id]/page.jsx
import Link from "next/link";
import { notFound } from "next/navigation";
import {
